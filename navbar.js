document.addEventListener('DOMContentLoaded', function() {
    ...
    const navbar = `
        ...
        <div class="navbar-item navbar-right">
            <div class="navbar-item">
                <a href="wishlist.html"><img src="./heart.png" alt="Heart"></a>
            </div>
            <div class="navbar-item dropdown">
                <a href="cart.html"><img src="./li-cart.png" alt="Cart"><span id="cart-quantity" class="cart-quantity"></span></a>
            </div>
            <div class="navbar-item dropdown">
